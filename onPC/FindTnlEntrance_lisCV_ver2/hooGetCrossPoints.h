...
CrossingPoints hooGetCrossPoints(Lane lane1, Lane lane2, Lane lane3)
{
	...
	cxPoints.pt1.x = (int) ceil( (b2-b1)/(a1-a2) );
	cxPoints.pt1.y = (int) ceil ( a1*cxPoints.pt1.x+b1 );

	cxPoints.pt2.x = (int) ceil(  (b3-b2)/(a2-a3) );
	cxPoints.pt2.y = (int) ceil(  a2*cxPoints.pt2.x+b2 );

	cxPoints.pt3.x = (int) ceil ( (b3-b1)/(a1-a3) );
	cxPoints.pt3.y = (int) ceil (a1*cxPoints.pt3.x+b1 );
